...
#coords_filename <- "data/usda_sites_coord_for_simulation.csv"
#outfile <- "data/usda_envs_cor_matrix.txt"
...
# save weather data
write_csv(env_data, 'data/environmental_weather_variables.csv')
...
if (heatmap) {
  ...
  pdf(heatmap_out, height = 7, width = 10)
