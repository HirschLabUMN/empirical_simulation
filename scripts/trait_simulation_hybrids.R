...
# trait <- "EHT"
# gwas_file <- "analysis/sim_traits/EHT/gwas_markers/gwas_top-350_markers.txt"
...
# real_pheno_file <- "data/1stStage_BLUEs.EHT-per-env.txt"
# effect_size_reduction <- 0.1
# seed <- 823162
# reps <- 3
# impute_type <- "Middle"
...
# 
# minor_qtls <- TRUE
# reduce_effect_all <- TRUE
# outfolder <- paste0("junk/", trait, "_per_env")
